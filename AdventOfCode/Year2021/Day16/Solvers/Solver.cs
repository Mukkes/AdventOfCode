using AdventOfCode.Year2021.Day16.Models;
using AdventOfCode.Year2021.Day16.Parsers;
using AdventOfCodeLibrary.Attributes;
using AdventOfCodeLibrary.Parsers;
using AdventOfCodeLibrary.Solvers;

namespace AdventOfCode.Year2021.Day16.Solvers;

[Solver]
public class Solver : BaseSolver<string>
{
    public override object? AnswerPartOne => 917;

    public override object? AnswerPartTwo => 2536453523344;

    protected override IInputParser<string> InputParser => new Parser();

    public override object SolvePartOne()
    {
        var packet = ExtractPacket(ParsedInput, out _);
